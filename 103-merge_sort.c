...
/**
 * merge_sort_temp - initiate merge sort
 * @array: array to be sorted
 * @temp: temporary array for holding sorted elements
 * @size: size of the array
 */
void merge_sort_temp(int *array, int *temp, size_t size)
{
	...
	merge_sort_temp(array, temp, half);
	merge_sort_temp(array + half, temp + half, size - half);
...
void merge_sort(int *array, size_t size)
{
	...
	merge_sort_temp(array, temp_array, size);
	free(temp_array);
}
